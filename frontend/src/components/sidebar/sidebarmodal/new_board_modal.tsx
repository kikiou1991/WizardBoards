        ...
        <ModalContent>
          ...
          <ModalBody className=' '>
            ...
            <div className='flex flex-row items-center'>
              <Select isRequired size='sm' label='Workspace' placeholder='Select a workspace' className='max-w-xs text-foreground ' onChange={(event) => setLocalSelectedWorkspace(event.target.value)}>
