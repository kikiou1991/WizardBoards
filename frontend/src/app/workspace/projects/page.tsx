  ...
  return (
    <div className='relative grow bg-background flex flex-col overflow-hidden mr-5'>
        ...
        <div className='flex w-full h-full overflow-x-auto items-start py-5 px-5  gap-5 mr-5'>
          ...
          {
            isActive ? (
              <div  ref={ref} className='relative text-black w-48  rounded min-h-80 border-solid border-2 border-foreground bg-[#dadada] px-1  flex flex-col overflow-y-auto overflow-x-hidden' style={{ minWidth: '272px', minHeight: '85px', maxHeight: '450px' }}>
                  <Input 
